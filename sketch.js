...
function preload(){
  bkgImage = loadImage("bkg.png");
  
  marioImage = loadAnimation("mario00.png");
  marioMoving = loadAnimation("mario01.png",  "mario02.png", "mario03.png");
  mariosJump = loadAnimation("mario03.png");
  mariolJump = loadAnimation("mario01.png"); 
  marioLeft = loadAnimation("mario00l.png");
  marioLeftMoving = loadAnimation("mario01l.png", "mario02l.png","mario03l.png");
  ...
  jumplSound = loadSound("jumpl.wav")
  jumpsSound = loadSound("jumps.wav")
  dieSound = loadSound("die.wav")
  //checkPointSound = loadSound("checkPoint.mp3");
  selectSound = loadSound("touch.wav");
  coinSound = loadSound("coin.wav");
  warningSound = loadSound("warning.wav");
  gameOverSound = loadSound("gameover.wav");
  music = loadSound("music.ogg");
  timeMusic = loadSound("timeMusic.ogg");
  stomp = loadSound("stomp.wav");
  brickSound = loadSound("brick.wav");
  win = loadSound("win.wav")
  
  marioFont = loadFont("emulogic.ttf");
  
  logoImage = loadImage("supermario.png");
  ...
  enemyMove = loadAnimation("enemy1.png", "enemy2.png");
  enemyKill = loadAnimation("enemy3.png");

  princessImage = loadImage("Princess Peach.png");
}
